...
var Apollo = function(connection, options){
    ...
    this._connection.authProvider = new cql.auth.PlainTextAuthProvider(this._connection.username, this._connection.password)
    this._client = null;
};
...
Apollo.prototype = {
    ...
    _get_system_client : function(){
        var copy_fields = ['contactPoints','authProvider'],
            temp_connection = {},
